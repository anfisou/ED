public class BSTree<T extends Comparable<? super T>> {   
    ...
    public int countBetween(T a,T b,BSTNode<T> n){
        if (n==null){return 0;}
        int c = 0;
        if (n.getValue().compareTo(a)>=0 && n.getValue().compareTo(b)<=0){c++;}
        if (a.compareTo(n.getValue()) <= 0){c += countBetween(a, b, n.getLeft());}
        if (b.compareTo(n.getValue()) >= 0){c += countBetween(a, b, n.getRight());}
        return c;
    }
    ...
    private boolean valid(BSTNode<T> n){
        ...
        return validleft(n)&&validright(n) && valid(n.getLeft()) && valid(n.getRight());

    }

    private boolean validleft(BSTNode<T> n){
        if (n == null){return true;}
        return validleft(n.getLeft(),n.getValue());
    }

    private boolean validleft(BSTNode<T> n, T v){
        if (n ==null){return true;}
        return v.compareTo(n.getValue())>0 && validleft(n.getLeft(),v) && validleft(n.getRight(),v);
    }
    private boolean validright(BSTNode<T> n){
        if (n == null){return true;}
        return validright(n.getRight(),n.getValue());
    }

    private boolean validright(BSTNode<T> n, T v){
        if (n ==null){return true;}
        return v.compareTo(n.getValue())<0 && validright(n.getLeft(),v) && validright(n.getRight(),v);
    }
   ...
   public int level(T v, BSTNode<T> n, int depth){
      if (n==null){return -1;}
